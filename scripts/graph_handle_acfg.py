# coding:utf-8
import sys
sys.path.insert(0, '/root/anaconda3/envs/py2/lib/python2.7/site-packages')
from func import *
        ...
        for i in range(len(func.g.node)):
            ...
            if __MODIFY__:
                node = [len(each_node_features[0]), len(each_node_features[1]), each_node_features[2], each_node_features[3],
                        ...
                        each_node_features[8], each_node_features[9], each_node_features[10], each_node_features[11]]
            else:
                node = [len(each_node_features[0]), len(each_node_features[1]), each_node_features[2], each_node_features[3],
                        each_node_features[4], each_node_features[5], each_node_features[6], each_node_features[7],
...
if __name__ == '__main__':
    ...
    # 保存的acfg的文件路径
    call_graph_and_acfg_filename = os.path.join(config.Feature_Attack.tmp_sample_root, pe_filename + '.json')
