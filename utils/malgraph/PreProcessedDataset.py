...
if __name__ == '__main__':
    root_path: str = '/home/newdisk/lx_11521065/MalAttack/MalGraph/processed_dataset/FilterDataset/'
    i_batch_size = 2
    
    train_dataset = MalwareDetectionDataset(root=root_path, train_or_test='TT')
    print(type(train_dataset), train_dataset.malware_root, train_dataset.benign_root)
    ...
    print(type(valid_dataset), valid_dataset.malware_root, valid_dataset.benign_root)
    ...
    print(type(test_dataset), test_dataset.malware_root, test_dataset.benign_root)
